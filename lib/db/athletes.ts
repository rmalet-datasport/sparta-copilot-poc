...
const POOL: Record<string, { male: string[]; female: string[]; last: string[]; cities: string[]; zip: string; phone: string; domain: string }> = {
  DK: {
    ...
    zip: '2', phone: '+45 ', domain: 'example.com',
  },
  SE: {
    ...
    zip: '1', phone: '+46 ', domain: 'example.com',
  },
  DE: {
    ...
    zip: '1', phone: '+49 ', domain: 'example.com',
  },
  UK: {
    ...
    zip: 'SW', phone: '+44 ', domain: 'example.com',
  },
  NL: {
    ...
    zip: '1', phone: '+31 ', domain: 'example.com',
  },
  NO: {
    ...
    zip: '0', phone: '+47 ', domain: 'example.com',
  },
  FR: {
    ...
    zip: '7', phone: '+33 ', domain: 'example.com',
  },
  US: {
    ...
    zip: '1', phone: '+1 ', domain: 'example.com',
  },
  IT: {
    ...
    zip: '2', phone: '+39 ', domain: 'example.com',
  },
  CH: {
    ...
    zip: '3', phone: '+41 ', domain: 'example.com',
  },
  PL: {
    ...
    zip: '0', phone: '+48 ', domain: 'example.com',
  },
  BE: {
    ...
    zip: '1', phone: '+32 ', domain: 'example.com',
  },
};
